...
static const char* JavaCPP_classNames[8] = {
...
static jclass JavaCPP_classes[8] = { NULL };
...
static const char* JavaCPP_members[8][1] = {
        { NULL },
        { NULL },
        { NULL },
        { NULL },
        ...
        { NULL },
        { NULL } };
static int JavaCPP_offsets[8][1] = {
        { -1 },
        { -1 },
        { -1 },
        { -1 },
        ...
        { -1 },
        { -1 } };
static int JavaCPP_memberOffsetSizes[8] = { 1, 1, 1, 1, 1, 1, 1, 1 };
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    for (int i = 0; i < 8 && !env->ExceptionCheck(); i++) {
...
JNIEXPORT jint JNICALL Java_com_example_HeadAndDllTest_add(JNIEnv* env, jclass cls, jint arg0, jint arg1) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rval = add(arg0, arg1);
        rarg = (jint)rval;
    } catch (...) {
...
JNIEXPORT void JNICALL Java_com_example_HeadAndDllTest_sayHello(JNIEnv* env, jclass cls) {
    jthrowable exc = NULL;
    try {
        sayHello();
    } catch (...) {
